               ...
               ///this.product.position.set(0, this.product.position.y, 0);
                ...
                $(window).scroll(function(){
                    ...
                    if (window.st > window.lastScrollTop) {
                        // downscroll code
                        window.direction = 1;
                        window.progress = ((window.progress + 1) >= 100) ? 100: window.progress + 1;
                    } else if (window.st < window.lastScrollTop) {
                        // upscroll code
                        window.direction = -1;
                        window.progress = ((window.progress - 1) <= 0) ? 0: window.progress - 1;
                ...
                GSAP.to(".second-move .details-tile .heading", {
                    scrollTrigger: {
                        //trigger: ".second-move",
                        trigger: ".second-move .details-tile",
                        //markers: true,
                ...
                GSAP.to(".second-move .details-tile p", {
                    scrollTrigger: {
                        //trigger: ".second-move",
                        trigger: ".second-move .details-tile",
                        //markers: true,
                ...
                GSAP.to(".third-move .details-tile .heading", {
                    scrollTrigger: {
                        //trigger: ".second-move",
                        trigger: ".third-move .details-tile",
                        //markers: true,
                ...
                GSAP.to(".third-move .details-tile p", {
                    scrollTrigger: {
                        //trigger: ".second-move",
                        trigger: ".third-move .details-tile",
                        //markers: true,
